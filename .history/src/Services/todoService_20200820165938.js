...
//Third console is asynchronous and cannot run until the http response body is finallly hydrated into a JS object

//fourth console is synchronous, so run immediately after the previous 
